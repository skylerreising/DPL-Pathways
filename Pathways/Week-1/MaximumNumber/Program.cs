...
(2) The amount of numbers should be between and include 1-5.
...
(3) Declare a variable maxNum and assign it the lowest possible value. (-100)
                ...
                do
                    {
                        ...
                        //assign the variable to hold each number the user wants compared
